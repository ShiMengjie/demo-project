 ...
 * 邀请码生成
 *
 * @author liuke04@corp.netease.com
 * @date 2021/3/1
 */
public class RandomCodeUtil {
    /**
     * 26个大写字母+10个数字，去掉容易混淆的，O、0、I、1等字
     */
     ...
     * 随机数据
     */
    private final static long SLAT = 1874986L;
    ...
    /**
     * 生成邀请码
     * 最后一位为校验码，最终可以生成id的最大值为32^7-1=34,359,738,367
     *
     * @param id 唯一的id主键
     * @return code
     */
    public static String generate(Long id) {
        ...
        b[CODE_LENGTH - 1] = checkSum * PRIME1 % CHARS_LENGTH;
        //进行混淆
